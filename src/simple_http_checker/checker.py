...
def check_urls(
    ...
    """
    Checks a lists of URLs and returns their status

    Args:
        urls: A list of URL strings to check
        timeout: Maximum time in seconds to wait for each request. Defaults tp 5

    Returns:
        A dictionary mapping each URLS to its status string
    """
